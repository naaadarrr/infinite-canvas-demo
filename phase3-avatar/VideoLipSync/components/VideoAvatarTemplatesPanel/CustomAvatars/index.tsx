...
import { useQueryCustomAvatar4Template } from '../../../hooks/mediaLibrary/useQueryCustomTemplate';
import { useDeleteCustomAvatarMutation } from '../../../data/mediaLibrary/useMutations';
...
export interface CustomAvatarsProps {
    ...
    return (
      <div className='flex-1 flex flex-col items-center justify-center text-white/40'>
        ...
        <p className='text-sm text-center'>
          Your used video avatars will appear here
        </p>
      </div>
    );
  }
