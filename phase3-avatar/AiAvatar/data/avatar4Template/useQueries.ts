...
/**
 * 命令式获取单个 Avatar4 模板
 * 用于 re-edit 场景中通过 avatarId 获取模板信息
 *
 * @returns fetch 函数，可直接调用获取模板数据
 */
export function useFetchPhotoAvatar4ById() {
  const utils = trpc.useUtils();
  return utils.avatar4.getPhotoAvatar4TemplateById.fetch;
}
